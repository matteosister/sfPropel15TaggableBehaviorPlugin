...
This plugin has also a widget for forms
...
- Create a tag field with **sfWidgetFormInputTags** widget in your form class
...
the widget has only one required option "taggable": the object (with taggable behavior) to tag.
...
Now your form has a widget with jquery autocomplete that read from the tag table. And a list of tags associated tags with checkbox to delete them.
